#include "TLAM36AIvsAIBeta3.h"
#include "FindClosestEntity__pf655108736.h"
...
UFindClosestEntity_C__pf655108736::UFindClosestEntity_C__pf655108736(const FObjectInitializer& ObjectInitializer) : Super()
{
	
}
PRAGMA_ENABLE_OPTIMIZATION
void UFindClosestEntity_C__pf655108736::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UFindClosestEntity_C__pf655108736::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void UFindClosestEntity_C__pf655108736::bpf__FindClosestEntity__pf(UClass* bpp__Class__pf, FVector bpp__TargetLocation__pf, UObject* bpp____WorldContext__pf, /*out*/ float& bpp__NearestDistance__pf, /*out*/ AActor*& bpp__NearestActor__pf)
{
	AActor* bpfv__NearestZombieActor__pf{};
	float bpfv__NearestZombieDistance__pf{};
	...
	do
	{
		...
		case 1:
			{
				bpfv__NearestZombieDistance__pf = 2000.000000;
			}
		case 2:
			{
				(bpfv__CallFunc_GetAllActorsOfClass_OutActors__pf).Reset();
				UGameplayStatics::GetAllActorsOfClass(bpp____WorldContext__pf, bpp__Class__pf, /*out*/ bpfv__CallFunc_GetAllActorsOfClass_OutActors__pf);
			}
		case 3:
			{
			}
		...
		case 13:
			{
				bpp__NearestDistance__pf = bpfv__NearestZombieDistance__pf;
				bpp__NearestActor__pf = bpfv__NearestZombieActor__pf;
				__CurrentState = -1;
				break;
			}
		case 14:
		...
		case 15:
			{
				...
				bpfv__CallFunc_Vector_Distance_ReturnValue__pf = UKismetMathLibrary::Vector_Distance(bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, bpp__TargetLocation__pf);
				bpfv__CallFunc_Less_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Less_FloatFloat(bpfv__CallFunc_Vector_Distance_ReturnValue__pf, bpfv__NearestZombieDistance__pf);
		...
		case 16:
			{
				...
				bpfv__CallFunc_Vector_Distance_ReturnValue__pf = UKismetMathLibrary::Vector_Distance(bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, bpp__TargetLocation__pf);
				bpfv__NearestZombieDistance__pf = bpfv__CallFunc_Vector_Distance_ReturnValue__pf;
			}
		case 17:
			{
				FCustomThunkTemplates::Array_Get(bpfv__CallFunc_GetAllActorsOfClass_OutActors__pf, bpfv__Temp_int_Array_Index_Variable__pf, /*out*/ bpfv__CallFunc_Array_Get_Item__pf);
				bpfv__NearestZombieActor__pf = bpfv__CallFunc_Array_Get_Item__pf;
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		default:
...
PRAGMA_DISABLE_OPTIMIZATION
void UFindClosestEntity_C__pf655108736::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UFindClosestEntity_C__pf655108736::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UFindClosestEntity_C__pf655108736
{
	FRegisterHelper__UFindClosestEntity_C__pf655108736()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Enemy/FindClosestEntity"), &UFindClosestEntity_C__pf655108736::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UFindClosestEntity_C__pf655108736 Instance;
};
FRegisterHelper__UFindClosestEntity_C__pf655108736 FRegisterHelper__UFindClosestEntity_C__pf655108736::Instance;
